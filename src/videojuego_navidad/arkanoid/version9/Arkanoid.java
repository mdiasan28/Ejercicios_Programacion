...
public class Arkanoid extends Canvas{
	...
	public void initWorld() { 
			...
			if (i == 0)brick.setColor(Color.red);
			if (i == 1)brick.setColor(Color.yellow);
			if (i == 2)brick.setColor(Color.blue);
			if (i == 3)brick.setColor(Color.MAGENTA);
			if (i == 4)brick.setColor(Color.green);
