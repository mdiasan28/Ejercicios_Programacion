...
public class Jugador extends Actor implements KeyListener, MouseMotionListener{
	// Propiedades específicas del jugador
		...
		private boolean left,right,space; // Booleanas que determinan si el player se está moviendo actualmente
		...
		public Jugador() {
			...
			spriteActual = SpritesRepository.getInstance().getSprite("nave-50x15.png");
	...
	public void keyPressed(KeyEvent e) {
	  	switch (e.getKeyCode()) {
			...
			case KeyEvent.VK_SPACE : fireMissile(); break;
	  	}
	  	updateSpeed();
	}
