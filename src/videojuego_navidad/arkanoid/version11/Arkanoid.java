...
public class Arkanoid extends Canvas{
	...
	public static final int ANCHO = 565;
	...
	// Referencia que guardaremos apuntando al objeto de tipo Player,ball y brick
	Jugador player = null;
	Pelota ball = null;
	Ladrillo brick = null;
...
//		g.setColor(Color.white);
//		g.setFont(new Font("Arial",Font.BOLD,20));
//		g.drawString(" YOU WIN", this.getWidth() / 2 - 50, this.getHeight() / 2);
//		strategy.show();
//	}
	...
	public boolean isGamewinner() { return winner; }
	public void setGamewinner(boolean winner) { this.winner = winner; }
}
