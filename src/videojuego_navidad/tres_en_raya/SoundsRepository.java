...
public class SoundsRepository {
	...
	private static String RESOURCES_FOLDER = "resources/sonidos/";
	
	// Recursos de sonido que puede utilizarse en el juego
	public static String MUSICA_DE_FONDO = "8bitsDB.wav";
	public static String EFECTO_JUGADOR_1 = "golpe.wav";
	public static String EFECTO_JUGADOR_2 = "Salto.wav";
